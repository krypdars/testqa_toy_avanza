    ...
    <form id="form1" runat="server">
        <div style="text-align: center">
            ...
            <input id="Button3" style="font-weight: bold; font-size: 9pt; font-family: Arial"
                type="button" value="<<< Atras" onclick="history.back();" /><asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                TabIndex="14" Text="Confirmar >>>" ValidationGroup="grupoMantencion" PostBackUrl="~/Registro_Mantenciones/Reg_Mantencion_04.aspx" OnClick="Button1_Click" />
            </div>
            <br />
                                ...
                                <td style="text-align: center; vertical-align: top;">
                                    <table style="border: thin groove #000000; width: 95%;">
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="WhiteSmoke" colspan="3" style="vertical-align: middle; text-align: left">
                                                <asp:Label ID="lblMotivoRechazoSeleccionado" runat="server" Font-Names="Arial" Font-Size="10pt" Font-Bold="True"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
