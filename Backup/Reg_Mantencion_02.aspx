                        ...
                        <tr>
                            <td style="text-align: center; vertical-align: top;">
                                            ...
                                            <table style="border: thin groove #000000; width: 95%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="WhiteSmoke">
                                                        <asp:RadioButtonList ID="rdEstado" runat="server" CellPadding="2" CellSpacing="2" RepeatDirection="Horizontal" Visible="False">
                                        ...
                                        <td>
                                            <table style="text-align: center; vertical-align: top;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left; height: 24px;" bgcolor="#ffffd9" width="32%">
                                                        <asp:DropDownList ID="Mantencion" runat="server" Font-Names="Arial" Font-Size="8pt"
                                                            ...
                                                            OnSelectedIndexChanged="Mantencion_SelectedIndexChanged">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left; height: 24px;" bgcolor="#ffffd9">
                                                        <asp:TextBox ID="TxtKM" runat="server" Font-Names="Arial" Font-Size="8pt" TabIndex="5" Width="70px" AutoPostBack="True"></asp:TextBox><asp:RequiredFieldValidator
                                ...
                                <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                                    TabIndex="8" Text="Continuar >>>" ValidationGroup="grupoMantencion" OnClick="Button1_Click" />
                                <br />
                                <br />
                                <br />
                            </td>
