...
public partial class Registro_Mantenciones_Reg_Mantencion_03 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["estadoT10"] != null) rdEstado.SelectedValue = Session["estadoT10"].ToString().Trim();
        lblMotivoRechazoSeleccionado.Visible = false;
        lblMotivoRechazo.Visible = false;
        if (Session["MotivoRechazo"] != null) lblMotivoRechazoSeleccionado.Text = Session["MotivoRechazo"].ToString();
        ValidaProgramaT10();
        #endregion
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (Session["estadoT10"] == null) Session["estadoT10"] = rdEstado.SelectedValue;
        ...
        if (rdEstado.SelectedValue == "Rechazar") Session["MotivoRechazo"] = lblMotivoRechazoSeleccionado.Text;
    ...
    protected void ValidaProgramaT10()
    {
        ...
        string marca = Obtiene_Marca(Label10.Text);
        #endregion
        switch (marca)
        {
            case "TOY":
            case "LEX":
                ...
                {
                    lblMotivoRechazoSeleccionado.Visible = true;
